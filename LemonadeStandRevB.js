...
function main() {
	...
	while (days>0) {
	    ...
	    cupMessage = "NOTE: Historical data shows total daily or weekly cups required is correlated to the high temperature.  Please review forecast prior to entering number of cups to buy:";
	    cupCount = getShoppingList(cupMessage);
	    lemonMessage = "Please enter number of lemonade servings to buy (NOTE: One serving equals one cup of lemonade:";
